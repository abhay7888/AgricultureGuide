    ...
    <ul class="navbar-nav">
      ...
      <!-- <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="">View Crops</a>
        </div>
      </li> -->
      <li class="nav-item active">
        <a class="nav-link" href="viewInsecticide.jsp">Insecticide</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="viewEquipment.jsp">Equipment</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="viewPesticide.jsp">Pesticide</a>
      </li>
