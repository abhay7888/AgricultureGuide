					...
					<div class="card-body">
						<form action="PesticideCtrl" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label for="">Pesticide Name</label> <input
									type="text" class="form-control" name="cname"
									id="exampleInputEmail1" aria-describedby="emailHelp"
									placeholder="Enter Pesticide name" required>

							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">Pesticide Range</label> <input
									type="text" name="range" class="form-control"
									id="exampleInputPassword1" placeholder="Enter range">
							</div>
							
							<div class="form-group">
								<label for="exampleInputPassword1">Pesticide Image</label> <input
									type="file" name="image" class="form-control"
									id="exampleInputPassword1" placeholder="Password">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">Pesticide Description</label> 
								<textarea rows="3" cols="3" name="desc" class="form-control"></textarea>
							</div>

							<button type="submit" class="btn btn-primary"name="Action" value="Add">Save Pesticide</button>
							&nbsp;&nbsp;&nbsp;
							<button type="reset" class="btn btn-primary">Reset Pesticide</button>
						</form>
					</div>
				</div>
