...
<body>
	<br>
	<h1 align="center">All Insecticide Information</h1>
	<br>
	<div class="row">
		...
		<div class="col-sm-10">
			<table>
				...
				String sql = "SELECT * from f_insecticide";
				...
				<tr>
					...
					<td class="btn-group-vertical"><a href="editinsect.jsp?id=<%=rs.getInt(1)%>"
						class="btn btn-primary">Edit Image</a> <a
						href="deleteinsect.jsp?id=<%=rs.getInt(1)%>"
